...
3. Check you're on the correct branch from PRD `branchName`. If not, check it out or create from main. Be sure to link the branch to a corresponding Linear issue.
...
10. Be sure include the corresponding Linear issue number in the commit message so they are linked.
...
```
## [Date/Time] - [Story ID] - Linear Issue: [Linear Issue Number]
